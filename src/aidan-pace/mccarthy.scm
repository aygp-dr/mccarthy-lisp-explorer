;; mccarthy.scm - Main module to re-export all components
;;
;; This file re-exports all components from the McCarthy Lisp explorer

(define-module (aidan-pace mccarthy)
  #:use-module (aidan-pace mccarthy core-functions)
  #:use-module (aidan-pace mccarthy evaluator)
  #:re-export (
    ;; From core-functions
...
(define (display-welcome)
  ...
  (display "Core functions: null?, equal?, append, pair, assoc\n")
  (display "Mathematical functions: factorial, gcd-recursive, sqrt-approx\n")
  (display "Evaluator: eval, apply, evlis, evcon\n\n")
...
(if (equal? (current-module) (resolve-module '(aidan-pace mccarthy)))
    (display-welcome))