...
#+PROPERTY: header-args:scheme :eval yes :exports both :tangle-dir "./presentation" :mkdirp yes
#+PROPERTY: header-args:coq :eval no :exports both :tangle-dir "./presentation" :mkdirp yes
...
#+BEGIN_SRC scheme :tangle s-expressions.scm
...
#+BEGIN_SRC scheme :tangle evaluator-simple.scm
...
#+BEGIN_SRC coq :tangle plus-comm.v
...
#+BEGIN_SRC scheme :tangle commutative-add.scm
